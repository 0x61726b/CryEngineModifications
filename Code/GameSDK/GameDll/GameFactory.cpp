...
#define REGISTER_VEHICLEOBJECT(name, obj) \
	...
	//Arkenthera
	REGISTER_GAME_OBJECT(pFramework, ProceduralCollectibleSystem, "Scripts/Entities/arken/ProceduralCollectibleSystem.lua");
	REGISTER_GAME_OBJECT(pFramework, CraftableCollectible, "Scripts/Entities/arken/CraftableCollectible.lua");
