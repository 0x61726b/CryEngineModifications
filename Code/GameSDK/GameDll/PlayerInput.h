...
class CPlayerInput : public IPlayerInput, public IActionListener,public IHardwareMouseEventListener
{
public:
...
class CIsometricInput : public IPlayerInput
{
public:
	enum EMoveButtonMask
	{
	...
	CIsometricInput( CPlayer * pPlayer );
	~CIsometricInput();
