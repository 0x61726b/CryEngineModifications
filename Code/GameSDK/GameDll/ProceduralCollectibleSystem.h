...
#ifndef __ProceduralCollectibleSystem_h__
#define __ProceduralCollectibleSystem_h__
#pragma once
//----------------------------------------------------------------------------
...
class CProceduralCollectibleSystem : public CGameObjectExtensionHelper<CProceduralCollectibleSystem, IGameObjectExtension>
{
...
public:
	CProceduralCollectibleSystem();
	virtual ~CProceduralCollectibleSystem();
