...
class CIsometricCameraMode : public ICameraMode
{
private:

public:
	CIsometricCameraMode();
	virtual ~CIsometricCameraMode();
...
private:
	CCameraPose IsometricCameraPose(const CPlayer& clientPlayer, float frameTime);
};
